...
**Accepted**, **Proposed**, **Deferred**, **Shelved**, **Superseded** and
**Rejected**. The [ADR register](ADR-REGISTER.md) is authoritative.

The repository contains several legacy parallel ADRs that reused numbers
