...
OpenData is a Java 17 command-line modular monolith. One process loads the
classpath plugin registry, resolves classpath or database-backed configuration,
