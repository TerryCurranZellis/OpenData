...
/**
 * SQL Server bindings for adjustment gas billing records.
 *
 * @author Terry Curran
 * @version 3.1.0
 * @since 3.1.0
 */
final class AdjustmentGasRecordUpsertAdapter
        extends AbstractAdjustmentUpsertAdapter<GasRecord> {
    ...
    private static final String INSERT_SQL = """
            INSERT INTO octopus.adjustment_gas_data
    ...
    private static final String UPDATE_SQL = """
            UPDATE octopus.adjustment_gas_data
    ...
    AdjustmentGasRecordUpsertAdapter() {
