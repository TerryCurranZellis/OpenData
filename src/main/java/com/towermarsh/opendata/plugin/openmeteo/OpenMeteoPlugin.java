...
public final class OpenMeteoPlugin implements OpenDataPlugin {
    ...
    /**
     * Runs the download, extract, validate, and transform stages without
     * loading.
     *
     * @return
     * @throws
     * com.towermarsh.opendata.plugin.openmeteo.exception.OpenMeteoException
     */
    ...
    /**
     *
     * Runs the download, extract, validate, and transform stages for an
     * explicit date range.
     *
