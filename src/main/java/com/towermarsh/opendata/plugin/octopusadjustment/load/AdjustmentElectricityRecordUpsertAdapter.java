...
/**
 * SQL Server bindings for adjustment electricity billing records.
 *
 * @author Terry Curran
 * @version 3.1.0
 * @since 3.1.0
 */
final class AdjustmentElectricityRecordUpsertAdapter
        extends AbstractAdjustmentUpsertAdapter<ElectricityRecord> {
    ...
    private static final String INSERT_SQL = """
            INSERT INTO octopus.adjustment_electric_data
    ...
    private static final String UPDATE_SQL = """
            UPDATE octopus.adjustment_electric_data
    ...
    AdjustmentElectricityRecordUpsertAdapter() {
